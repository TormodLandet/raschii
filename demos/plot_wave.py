...
def plot_wave(model_names, height, depth, length, N, depth_air, blend_height,
    ...
    for model_name in model_names:
        ...
        if plot_quiver:
            ...
            ax1.quiver(X, Y, U, V, scale_units='height', scale=scale,
...
def main():
    ...
    parser.add_argument('wave_type', help='Name of the wave model. '
                        'You can specify several, e.g., "Fenton,Airy"')
    ...
    parser.add_argument('-v', '--velocities', default=False, action='store_true',
    ...
    parser.add_argument('-b', '--blend_height', default=-1, type=float,
    ...
    plot_wave(model_names=model_names,
