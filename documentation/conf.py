...
latex_documents = [
    (master_doc, 'raschii.tex', 'raschii Documentation',
     'Tormod Landet', 'manual'),
]
...
man_pages = [
    (master_doc, 'raschii', 'raschii Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'raschii', 'raschii Documentation',
     author, 'raschii', 'One line description of project.',
     'Miscellaneous'),
]
